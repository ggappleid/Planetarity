...
public partial class GameEntity {
    ...
    public void AddCollision(UnityEngine.GameObject newOriginalObj, UnityEngine.GameObject newHitObj) {
        var index = GameComponentsLookup.Collision;
        var component = (CollisionComponent)CreateComponent(index, typeof(CollisionComponent));
        component.originalObj = newOriginalObj;
        component.hitObj = newHitObj;
        AddComponent(index, component);
    }

    public void ReplaceCollision(UnityEngine.GameObject newOriginalObj, UnityEngine.GameObject newHitObj) {
        var index = GameComponentsLookup.Collision;
        var component = (CollisionComponent)CreateComponent(index, typeof(CollisionComponent));
        component.originalObj = newOriginalObj;
        component.hitObj = newHitObj;
