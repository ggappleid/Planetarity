...
public partial class GameEntity {
    ...
    public void AddPlayer(string newPlanet, PlayerType newType, float newBotStrength, bool newIsAlive) {
        ...
        component.BotStrength = newBotStrength;
        component.IsAlive = newIsAlive;
        AddComponent(index, component);
    }

    public void ReplacePlayer(string newPlanet, PlayerType newType, float newBotStrength, bool newIsAlive) {
        var index = GameComponentsLookup.Player;
        var component = (PlayerComponent)CreateComponent(index, typeof(PlayerComponent));
        component.Planet = newPlanet;
        component.Type = newType;
