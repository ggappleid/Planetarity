...
public partial class Contexts : Entitas.IContexts {
    ...
    public GameInfoContext gameInfo { get; set; }
    public InputContext input { get; set; }

    public Entitas.IContext[] allContexts { get { return new Entitas.IContext [] { game, gameInfo, input }; } }
...
public partial class Contexts {
    ...
    public void InitializeContextObservers() {
        try {
            ...
            CreateContextObserver(gameInfo);
